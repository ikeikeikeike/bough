...
Run `bough evolve $ARGUMENTS` to run the 5-gate pipeline that clusters instincts
into candidate skills / agents / commands.

If the user wants to actually emit artifacts, use `bough evolve --generate`. Note
